...
\NP Connecting the Manta. Connect and power on the Manta to the Amphibian Portable PC as before. When you open the Amp\_2\_2\_6, the Main screen (A) will appear. This is where you will see data readings. To log, or store, one line of data take a "snapshot" with the top left button. To locate snapshots, open the PDA menu and select "snapshot locations"(B). In the SS locations screen (C) you can edit your files or a create new one. When creatign a new file (D), annotate using the guidelines in 10.5.To see data presented graphically, open the PDA menu and select "graphing" (B). 

\NP Amphibian Working Screens

\includegraphics[scale=0.5]{AmphibianMain.png}

\NP Shortcut buttons...

\NP Enable GPS. To turn on GPS, tap on the GPS/GNSS status gadget shown below. A satellite icon will appear on the bar across the top. Once satellites are found, information similar to that in the image below will appear.
