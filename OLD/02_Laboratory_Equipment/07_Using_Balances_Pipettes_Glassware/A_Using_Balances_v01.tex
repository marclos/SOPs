...
\section{Switching on the balance}
...
See also
Switching on the balance   Page 19
...
The balance is tared. The icon
Net
 appears.
4.6.3 Performing a weighing
1 Open the draft shield, if applicable.
2 Place the weighing object into the sample vessel.
3 Tap Add result if you want to report the weighing result.
