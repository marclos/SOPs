...
![RStudio Server login page](../images/rstudio_server_login.png){width=80% fig-align="center"}
...
![RStudio Server login page](../images/rstudio_four_panels.png){width=80% fig-align="center"}
