...
begin{itemize}
\item Collect water samples in sterile 100 mL containers, ensuring they are filled to the marked line.
\item If the sample is chlorinated, ensure the presence of sodium thiosulfate in the container.
\item 
\end{itemize}
