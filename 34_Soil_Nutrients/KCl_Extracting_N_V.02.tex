...
\NP Graduated cylinder or repipet type dispenser
...
\NP Specimen containers, solo cups or Nalgene bottles 

\NP Sample cups and caps 
...
\NP Weigh out 298.2 g KCL to volumetric flask

\NP Fill volumetric flask with approximately 2/3rds of ....

\NP Place ______ on _____ scale

\NP Place a ____ magnet into _____

\NP Turn on scale to .... low level shaking 
...
\NP Fill volumetric container w/ 40 ml solution

\NP Add 10g of soil into container until solution reaches 50 ml

\NP Cap and shake using shaker for 2 hours

\NP Allow sample to sit and soil particles to settle (around 10 mins, no more than 1hr)

\NP Place filter paper inside funnels, and set up funnels to drain into labeled containers
