...
The functionality of R and Github for data analysis and collaboration can be combined using Rstudio. These robust tools for the scientist and data analyst  which we will use to 
