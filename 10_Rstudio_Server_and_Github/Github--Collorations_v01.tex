...
You want to make pull requests after you make changes to your work that you want to be reflected in everyone else’s repository. You will need to create a pull request to do this. For this class you will make one pull request each week, on Friday's so that your work can be looked at by Marc over the weekend. 
