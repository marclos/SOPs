...
\author{Kristy Morris -- Revision by Isaac Medina}
...
%\section{Procedure} until we figure out how to fix the \NP command we're going to split the "PROCEDURE" section into two separate sections. 
\section{Extraction}
...
\NP 2.5 mL of each sample will be dispensed into a clean glass cuvette, again taking care not to resuspend filter particles.
...
\NP Use the 90\% acetone solution for a blank measurement on the sensitivity setting that will be used for sample analysis. % Not sure what is the sensitivity setting this part is referring too. clarify this!
