...
This SOP was orginally written by Isaac Medina and then substantially updated and improved by Virginia Pascal. 
...
\subsection{Extracted Chlorophyll Measurements with the Chl $\alpha$-Acidification Fluorescent Module}
