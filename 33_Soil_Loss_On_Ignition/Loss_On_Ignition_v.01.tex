...
\NP The muffled furnace burns up to 3000$^\circ$C, posing a threat to significant 4th degree burns
...
\NP This procedure requires X hours to complete.
...
\NP Prepare the soil samples in advance. Samples should be sieved with a 2mm sieve.
  ...
  \begin{enumerate}
	...
	\item Take samples out of the oven after oven-drying.% and place them in a desiccator.
	\end{enumerate}
	
\subsection{Ignition}

\NP Once ready for ignition, we can begin heating the oven while preparing the crucibles.The Geology Dept. has multiple muffled furnaces. This SOP instructs how to use the Nabertherm furnace.
    Use the dial knob to set the furnace to the correct program preset called "LOI" and assure it is aet to the correct temperature of 360^\circ$C.
\NP Then, for each sample...
  \begin{enumerate}
	\item Record the weight of the crucible on a scale capable of precision to 0.001
	\item Weigh out 5.000g ±0.001g of the oven-dried sample into a crucible.
