...
\NP Ignition of the soil samples in a muffled furnace burns off any organic matter and water content, leaving only the mineral content. The weight difference of the samples before and after ignition represents the OM\%.
...
\NP Prepare the soil samples in advance. Samples should be sieved with a 2mm sieve.
  ...
  \begin{enumerate}
	\item Weigh out desired sample masses on an metal tin, make sure to label (etch with pencil) and tare out weight of the tin. Record the air-dry mass for reference if necessary.
	...
	\item Tare out and record the weight of the  crucible on a scale capable of precision to 0.001.
	\item Weigh out 5.000g ±0.001g of each oven-dried sample into a crucible. Record this as the pre-ignition weight. 
