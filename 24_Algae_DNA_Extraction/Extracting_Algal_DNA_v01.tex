...
\usepackage{Sweave}
\begin{document}
\input{Extracting_Algal_DNA_v01-concordance}
...
This SOP was originally written by Aparna...
...
\NP Preheat Elution Buffer PE to 65 °C
...
\NP Do this until all 4 tubes are balanced and place into the centrifuge with balanced pairs on opposite sides. Run the centrifuge at 4°C for 20 min at 4000rpm.
...
\NP Incubate the suspension for 10 min. at 65°C. *For some plant material it might be advantageous to increase incubation time to 30-60 min. 
...
\NP Add 450$\mu$L Buffer Pc and mix thoroughly by pipetting up and down (~5 times) or by vortexing


\subsection*{Bind DNA}

\NP Place a Green Ring Nucleospin Column into a new 2mL Collection Tube and load a maximum of 700µL of the sample.
...
\NP 1st Wash: Add 400µL Buffer PW1 to Green Column. Centrifuge for 1 min at 11,000 x g and discard flow-through.

\NP 2nd Wash: Add 700µL Buffer PW2 to Green Column. Centrifuge for 1 min at 11,000 x g and discard flow-through.
...
\NP Place the Green Column into a new 1.5mL Eppendorf tube and pipette 32$\mu$L Buffer PE (preheated at 65°C) onto the membrane. 

\NP Incubate these tubes for 5 min at 65°C. Then centrifuge for 1 min at 11,000 x g to elute the DNA.

\NP Repeat the previous step with another 50$\mu$L Buffer PE (65°C) and elute into the same tubes, and run under centrifuge again.
