...
\NP MilliQ Water System (Serial Number xxx)
...
\begin{itemize}
  \item Quauntum TEX Cartridge (Cat. No. QTUM0TEX1)
  \item Prograde S2 Pre-Treatment Pack (Cat. No. PR0G0T0S2US) 
  \item Reservior Vent Filter (Cat No. XXX)
  \item 
\end{itemize}
