...
=======
sample.source = "/home/CAMPUS/im022012/SOPs/32_Soil_Texture_Analysis/Data/170207sample.csv"
reading.source = "/home/CAMPUS/im022012/SOPs/32_Soil_Texture_Analysis/Data/170207reading.csv"
>>>>>>> 10315cd4220e003b42bdac4215168516e40516d8

sample.import <- read.csv(sample.source)
reading.import <- read.csv(reading.source)

#Deleting observations with missing blank observations
reading.import$missing_blank<- is.na(reading.import$blank)
reading.import<- subset(reading.import, subset = (missing_blank=="FALSE"))
...
We often get errors here, which seem to be associated with an database import problem, where sample.csv has an extra column that screws the read.csv function up. After manually deleted the empty column, everything seems to work.

```{r, echo=F}

#Function Below bugging out so I merged on my own instead 
#sample <- RemoveMissingKEYs(sample.import, reading.import)

 sample<- merge(sample.import, reading.import, by.x= "sampleKEY")
```
