...
\NP To obtain a random sample from a known x and y distance, using the following Rmd file: XY\_Random.R

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: <text>:4:0: unexpected end of input\\\#\# 2: source(YX\_Random.R)\\\#\# 3: print(xtable(LocationOrdered)\\\#\#\ \  \textasciicircum{}}}\end{kframe}
\end{knitrout}
