...
\usepackage{Sweave}
\begin{document}
\input{Rstudio-and-Github_v03-concordance}
\maketitle
...
As usual we acknowledge the students who have tried to follow and made suggestions in how to improve this guide. In particular, Aparna C, etc. ABC
...
\NP Rather than downloading these things, use the Rstudio Server located at rstudi.campus.pomona.edu. Login using your Pomona College username and password.
